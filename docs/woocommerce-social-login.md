...
---
  ...
  <p>
    The best hook to use is probably `cfw_checkout_after_login`, but you can use any of the hooks <a href="https://cfw.test/documentation/actions" target="_blank">in our documentation</a>.&nbsp;
  </p>
